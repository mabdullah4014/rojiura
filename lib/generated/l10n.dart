...
class S {
  ...
  /// `内容を入力する`
  String get enter_post_desc {
    return Intl.message(
      '内容を入力する',
      name: 'enter_post_desc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `内容を入力する300未満`
  String get enter_post_desc_valid {
    return Intl.message(
      '内容を入力する300未満',
      name: 'enter_post_desc_valid',
      desc: '',
      args: [],
    );
  }
  ...
  /// `コメントできません`
  String get unable_to_comment {
    return Intl.message(
      'コメントできません',
      name: 'unable_to_comment',
      desc: '',
      args: [],
    );
  }
  ...
  /// `カテゴリーを選択して進む`
  String get select_topic_proceed {
    return Intl.message(
      'カテゴリーを選択して進む',
      name: 'select_topic_proceed',
      desc: '',
      args: [],
    );
  }
  ...
  /// `※本サービスの利用者は利用規約に同意したものとみなします`
  String get terms_of_service_agreement {
    return Intl.message(
      '※本サービスの利用者は利用規約に同意したものとみなします',
